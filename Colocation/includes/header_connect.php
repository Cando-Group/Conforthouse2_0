<?php
    ...
    $reqUser = $database->prepare("SELECT * FROM collocusers WHERE username=:username");
    $reqUser->bindvalue(":username", $_SESSION["coloc"]);
    $reqUser->execute();
...
<img src="../assets/img/account/user-1.jpg" alt="Photo de profile" style="width:35px;height:35px;">
</div>
<ul class="dropdown-menu dropdown-menu-end">
<!-- <li><a class="dropdown-item" href="profile.php"><i class="far fa-user"></i> Mon profile</a></li> -->
<li><a class="dropdown-item" href="add-property.php"><i class="far fa-plus-circle"></i> Ajouter de colocation</a></li>
...
<li class="nav-item">
<a class="nav-link" href="coloc.php">Colocation</a>
...
<div class="dropdown">
<div data-bs-toggle="dropdown" aria-expanded="false">
<img src="../assets/img/account/user-1.jpg" alt="Profile" style="width:60px;height:60px;">
</div>
<!-- Changer les fichgiers de colocation pour le menu déroulant -->
<ul class="dropdown-menu dropdown-menu-end">
<li><a class="dropdown-item" href="profile.php"><i class="far fa-user"></i> Mon profile</a></li>
<li><a class="dropdown-item" href="add-property.php"><i class="far fa-plus-circle"></i> Publier une colocation</a></li>
