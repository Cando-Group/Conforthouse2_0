<?php
    ...
    $reqAgentEtudiants = $database->prepare("SELECT * FROM demarcheurs WHERE email=:email");
    $reqAgentEtudiants->bindvalue(":email", $email);
    $reqAgentEtudiants->execute();

    $dataAgentEtudiants = $reqAgentEtudiants->fetch();
...
<div class="container">
<h2 class="breadcrumb-title">Chambres étudiantes / personnelles(<?=$dataAgentEtudiants['nom']. " ". $dataAgentEtudiants['prenoms']?>)</h2>
<ul class="breadcrumb-menu">
<li><a href="index.php">Accueil</a></li>
<li class="active">Chambres étudiantes / personnelles(<?=$dataAgentEtudiants['nom']. " ". $dataAgentEtudiants['prenoms']?>)</li>
</ul>
</div>
</div>
        ...
        <div class="listing-bottom">
          <div class="listing-author">
            <div class="listing-author-img">
              <img src="upload/profile/<?=$dataAgentEtudiants['photo']?>" alt="Profil" style="width:45px;height:45px;">
            </div>
...
<!-- Le reste de votre code HTML -->
        ...
        <div class="pagination-area mb-5">
            <div aria-label="Page navigation example">
                <ul class="pagination">
                <li class="page-item">
                    <a class="page-link" href="agentEtudiants.php?email=<?=$email?>&page=<?php echo $pageActuelle - 1; ?>" aria-label="Previous">
                    <span aria-hidden="true"><i class="far fa-angle-double-left"></i></span>
                    </a>
                </li>
                <!-- Vous pouvez laisser les liens statiques pour les pages 1, 2 et 3 pour l'instant -->
                <li class="page-item <?php echo ($pageActuelle == 1) ? 'active' : ''; ?>"><a class="page-link" href="agentEtudiants.php?email=<?=$email?>&page=1">1</a></li>
                <li class="page-item <?php echo ($pageActuelle == 2) ? 'active' : ''; ?>"><a class="page-link" href="agentEtudiants.php?email=<?=$email?>&page=2">2</a></li>
                <li class="page-item <?php echo ($pageActuelle == 3) ? 'active' : ''; ?>"><a class="page-link" href="agentEtudiants.php?email=<?=$email?>&page=3">3</a></li>
                <li class="page-item">
                    <a class="page-link" href="agentEtudiants.php?email=<?=$email?>&page=<?php echo $pageActuelle + 1; ?>" aria-label="Next">
