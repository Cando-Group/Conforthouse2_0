                ...
                <div class="row align-items-center gx-0">
                  <div class="col">
                    ...
                    <h6 class="text-uppercase text-muted mb-2">
                      ...
                      <?php
                        $demarcheur = $database->prepare('SELECT * FROM collocusers');
                        $demarcheur->execute();
                        $countUsers = $demarcheur->rowCount();
                    ?>
                    </h6>

                    <!-- Heading -->
                    <span class="h2 mb-0">
                      <span class="text-danger"><?= $countUsers?></span>
                    </span>
              ...
              <div class="card-body">
                <div class="row align-items-center gx-0">
                  <div class="col">
                    ...
                    <!-- Title -->
                    <h6 class="text-uppercase text-muted mb-2">
                      <a href="demarcheurs.php">Agents immobilier</a>
                    </h6>

                    <?php
                        $demarcheur = $database->prepare('SELECT * FROM demarcheurs');
                        $demarcheur->execute();
            ...
            <div class="card">
              <div class="card-body">
                <div class="row align-items-center gx-0">
                  <div class="col">
                    <?php
                        $location = $database->prepare("SELECT * FROM annonces WHERE louer='oui' ");
                        $location->execute();
            ...
            <div class="card">
              <div class="card-body">
                ...
                <?php
                    ...
                    $nombreAnnonce = $database->query('SELECT * FROM annonces');
            ...
            <div class="card">
              <div class="card-body">
                ...
                <?php
                    ...
                    $nombreNewsletter = $database->query('SELECT * FROM newsletter');
