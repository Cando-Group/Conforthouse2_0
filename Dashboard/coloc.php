              ...
              <table class="table table-sm table-nowrap card-table">
                ...
                <tbody class="list">
                    ...
                    <?php
                        ...
                        $infoAnnonces = $database->prepare('SELECT * FROM annoncescolocations ORDER BY id DESC');
                        ...
                        while ($dataAnnoncesInfo = $infoAnnonces->fetch()){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="delete_coloc.php?id=<?= $dataAnnoncesInfo['id']?>" class="btn btn-danger mb-2">Supprimer</a>
                                </td>
                            </tr>
                    <?php
                        }
