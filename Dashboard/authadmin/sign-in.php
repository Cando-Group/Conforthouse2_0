<?php
    ...
    if (isset($_POST['adminConnect'])){
        ...
        if (!empty($_POST['username']) && !empty($_POST['password'])){
            ...
            $verifyConnect = $database->prepare('SELECT * FROM admin WHERE username=:username AND password=:password');
...
<head>
    <title>I HOUSE - Admin Connection </title>
                        ...
                        <form class="md-float-material" method="post">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <input type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" value="Sign in" name="adminConnect">
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
